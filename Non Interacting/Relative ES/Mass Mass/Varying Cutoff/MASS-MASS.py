...
with open("Cutoff.dat","r") as MyFile:
	n_cutoff = int(MyFile.read())

reader1 = csv.reader(open('SingleBandCutoff_' +str(30) +'_M' +str(mz) +'N.csv', "r"))
reader2 = csv.reader(open('SingleBandCutoff_' +str(30) +'_M' +str(mz) +'P.csv', "r"))
O1 = {}
O2 = {}
for k,v in reader1:
    O1[k] = v
